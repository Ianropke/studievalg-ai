...
export function Header() {
  ...
  return (
    <header className="max-w-5xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-[#E7E9EF] bg-[#FFFFFF]">
      ...
      <nav className="flex items-center gap-4 sm:gap-6 text-xs font-semibold overflow-x-auto max-w-full pb-1 sm:pb-0">
        {navItems.map((item) => {
          const isActive =
            pathname === item.href ||
